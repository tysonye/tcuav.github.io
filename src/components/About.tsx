        ...
        <div className="mb-24">
          ...
          <div className="relative">
            ...
            <div className="space-y-16">
              {/* 2021年 */}
              <div className="relative flex items-center justify-between flex-col md:flex-row md:flex-row-reverse">
                ...
                <div className="hidden md:block md:w-1/2 md:pl-20"></div>
              </div>
              
              {/* 2022年 */}
              <div className="relative flex items-center justify-between flex-col md:flex-row">
                <div className="hidden md:block md:w-1/2 md:pr-20"></div>
